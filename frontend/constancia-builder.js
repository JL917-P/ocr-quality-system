          ...
          <html>
            <head>
              ...
              <style>
                ...
                .ct-transport th, .ct-transport td { font-size: 8px; padding: 2px 3px; }
                .ct-transport th:nth-child(1), .ct-transport td:nth-child(1) { width: 3%; white-space: nowrap; }
                .ct-transport th:nth-child(2), .ct-transport td:nth-child(2) { width: 7%; white-space: nowrap; }
                .ct-transport th:nth-child(3), .ct-transport td:nth-child(3) { width: 20%; }
                .ct-transport th:nth-child(4), .ct-transport td:nth-child(4) { width: 6%; white-space: nowrap; }
                .ct-transport th:nth-child(5), .ct-transport td:nth-child(5) { width: 54%; white-space: nowrap; }
                .ct-transport th:nth-child(6), .ct-transport td:nth-child(6) { width: 10%; white-space: nowrap; }
                @media print {
                  body { background: #fff; }
