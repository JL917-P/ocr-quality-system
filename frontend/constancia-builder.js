...
/** Firma por entorno: user01 usa firma propia; admin y resto usan firma.png */
      ...
      /** Detecta si la fecha de producción admin usa prefijo FP. */
      ...
      function computeAdminExpirationFromProduction(productionText, productName) {
        ...
        if (dayMonthYear) {
          ...
          const body = formatAdminDayMonthYearBody({
            ...next,
        ...
        if (numeric) {
          ...
          if (useFvPrefix) {
            return `FV${formatAdminDayMonthYearBody({
              ...next,
              monthCase: "upper",
              dayPadded: true,
            })}`;
